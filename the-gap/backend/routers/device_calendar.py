...
@router.post("/sync")
async def sync_device_calendar(body: DeviceCalendarSyncRequest, user_id: str = Depends(get_current_user_id)) -> JSONResponse:
    ...
    await upsert_device_calendar_rows(user_id, body.daily_rows)
